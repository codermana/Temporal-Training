...
// Worker and starter target a local dev server, a Dockerized cluster, or
// Temporal Cloud without code changes. Go mirror of the Java Connections.fromEnv().
//
...
// Getenv returns the environment variable key, or fallback when it is unset/empty.
