// Command worker runs the Hello Temporal Worker (standalone). It registers the
// Workflow + Activity and polls the hello-temporal Task Queue forever; start a
// run from another terminal with `go run ./starter`.
//
